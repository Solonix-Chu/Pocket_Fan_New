...
struct TextPool_en_t
{
    ...
    char AppSettings_Option_English[3] = "EN";
    char AppSettings_Option_Chinese[3] = "CN";
    ...
    char PocketFan_Menu_General[8] = "General";
    char PocketFan_Menu_Detail[7] = "Detail";
    char PocketFan_Menu_Health[7] = "Health";
    char PocketFan_Menu_Emoji[6] = "Emoji";
    char PocketFan_Menu_Enjoy[6] = "Enjoy";
    char PocketFan_Menu_About[6] = "About";
    char PocketFan_Menu_Quit[5] = "Quit";
    char PocketFan_Settings_OperationGuide[16] = "Operation Guide";
    char PocketFan_Settings_SystemMenuDemo[39] = "System Settings and Configuration Menu";
    char PocketFan_Settings_DarkTheme[11] = "Dark Theme";
    char PocketFan_Settings_InvertDisplay[15] = "Invert Display";
    char PocketFan_Settings_Theme[6] = "Theme";
    char PocketFan_Settings_Bluetooth[10] = "Bluetooth";
    char PocketFan_Settings_BluetoothPairing[18] = "Bluetooth Pairing";
    char PocketFan_Settings_EscCalibration[16] = "ESC Calibration";
    char PocketFan_Settings_Trackball[16] = "Trackball Color";
    char PocketFan_Settings_AnimSpeed[17] = "Anim Speed";
    char PocketFan_Settings_FactoryReset[14] = "Factory Reset";
    char PocketFan_Settings_LanguageFmt[13] = "Language: %s";
    char PocketFan_Settings_BrightnessFmt[10] = "BRI: %d%%";
    char PocketFan_Settings_AnimSpeedFmt[11] = "ANIM: %d%%";
    char PocketFan_Settings_ScreenSaverTimeoutFmt[16] = "ScreenSaver: %s";
    char PocketFan_Settings_TrackballModeFmt[9] = "Mode: %s";
    char PocketFan_Settings_TrackballMode_Random[14] = "Random Breath";
    char PocketFan_Settings_TrackballMode_Custom[7] = "Custom";
    ...
    char PocketFan_Settings_FactoryResetConfirm[42] = "MID confirm / any key exit";
    char PocketFan_Settings_EscCalibrating[32] = "ESC calibrating";
    char PocketFan_About_InfoFmt[25] = "FW: %s Build: %s MAC: %s";
    char PocketFan_About_Status_Writing[19] = "Status: Writing...";
    char PocketFan_About_Status_Waiting[27] = "Status: Waiting connect...";
    char PocketFan_About_Status_Starting[20] = "Status: Starting...";
    char PocketFan_About_Status_BleInitFailedFmt[30] = "Status: BLE init failed (%ld)";
    char PocketFan_About_ProgressFmt[26] = "Progress: %lu/%lu (%lu%%)";
    char PocketFan_About_ProgressBytesFmt[20] = "Progress: %lu bytes";
    char PocketFan_About_MidExit[10] = "MID: Exit";
    char PocketFan_About_CheckBtPsram[22] = "Check BT/PSRAM config";
    char PocketFan_Health_BatteryCyclesNA[19] = "Battery Cycles: --";
    char PocketFan_Health_BatteryHealthNA[19] = "Battery Health: --";
    char PocketFan_Health_MotorHoursNA[16] = "Motor Hours: --";
    char PocketFan_Health_MotorHealthNA[17] = "Motor Health: --";
    char PocketFan_Health_DeviceHealthNA[18] = "Device Health: --";
    char PocketFan_Health_SuggestionNA[15] = "Suggestion: --";
    char PocketFan_Health_BatteryCyclesFmt[21] = "Battery Cycles: %.0f";
    char PocketFan_Health_BatteryHealthFmt[23] = "Battery Health: %.0f%%";
    char PocketFan_Health_MotorHoursFmt[19] = "Motor Hours: %.1fh";
    char PocketFan_Health_MotorHoursOver[21] = "Motor Hours: >10000h";
    char PocketFan_Health_MotorHealthFmt[21] = "Motor Health: %.0f%%";
    char PocketFan_Health_DeviceHealthFmt[22] = "Device Health: %.0f%%";
    char PocketFan_Health_SuggestionBad[27] = "Suggestion: Replace device";
    char PocketFan_Health_SuggestionGood[17] = "Suggestion: Good";
