...
// 注意：这里所有的变量定义都*没有* `static` 关键字
// 因为它们需要在 ui_priv.h 中被 extern
...
const uint8_t icon_width[] = {35, 37, 36, 36};
...
uint8_t pid_num = sizeof(pid) / sizeof(SELECT_LIST);

SELECT_LIST list[] =
    {
        {"MainUI - This is a very long text string to test the scrolling feature"},
        {"+PID Editor"},
        {"-Icon Test"},
        {"-Chart Test"},
        {"-Text Edit"},
