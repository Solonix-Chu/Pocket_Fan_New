...
void setup_scr_screen_2(lv_ui *ui)
{
    ...
    ui->screen_2_img_1 = lv_image_create(ui->screen_2);
    lv_obj_set_pos(ui->screen_2_img_1, 2, 17);
    lv_obj_set_size(ui->screen_2_img_1, 124, 22);
    lv_obj_add_flag(ui->screen_2_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_2_img_1, &_start_124X22_RGB565A8_124x22);
